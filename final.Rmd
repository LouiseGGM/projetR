...
```{r recodages}
coco$coco1_q23[coco$coco1_q23 ==2.6] <- 3 #On transforme le 2,6 en 3 personne dans le foyer
...
freq(age_rec)
# Temps consacré par rappport à d'habitude à parler au telephone
...
```
<font size="2"> *Note : La pondération utilisée se base sur les 998 répondants de la vague 2 de CoCo, 151 d’entre eux n’ont pas répondu aux vagues 1, 2 et 3, et ont donc été exclus. 
