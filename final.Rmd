...
```{r carte}
region_sf <- st_read(dsn = "/regions-20180101-shp/regions-20180101-shp/regions-20180101.shp")
...
```
<font size="6">Note : La pondération utilisée se base sur les 998 répondants de la vague 2 de CoCo, 151 d’entre eux n’ont pas répondu aux vagues 1, 2 et 3, et ont donc été exclus. 
Lecture : Dans la région méditerranéenne, 26,15 % des personnes interrogées vivent seules lors du premier confinement. <br/>
