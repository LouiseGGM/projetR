...
a<-data.frame(wtd.table(coco$insee_NUTS1, coco$eayy_C1_rec, 
...
```{r carte}
region_sf <- st_read(dsn = "C:/Users/tripl/Documents/TD_R_M2/regions-20180101-shp/regions-20180101-shp/regions-20180101.shp")
